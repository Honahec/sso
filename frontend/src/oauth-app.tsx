...
const AuthorizePage: React.FC<AuthorizeContext> = (props) => {
  ...
  const combinedErrorsList = combineErrors(
    props.fieldErrors,
    ...
    <Container maxW="4xl" py={12}>
      ...
      >
        <VStack spacing={8} align="stretch">
          <Box borderBottom="2px" borderColor="gray.100" pb={4}>
          ...
          <form method="post" action={props.formAction ?? ""}>
            ...
            <VStack spacing={6} align="stretch">
              {fields.map((field) => (
                ...
                >
                  ...
                  />
                  {field.helpText ? (
                    <FormHelperText color="gray.500" fontSize="xs" mt={2}>
                      {field.helpText}
                    </FormHelperText>
                  ) : null}
                  {field.errors?.map((err, idx) => (
                    <Alert
                      key={`${field.name}-error-${idx}`}
                      status="error"
                      mt={2}
                      borderRadius="md"
                    >
                      <AlertIcon />
                      <AlertDescription fontSize="sm">{err}</AlertDescription>
                    </Alert>
                  ))}
                </FormControl>
              ))}
            ...
            <Box mt={10} pt={6} borderTop="1px" borderColor="gray.100">
...
const ApplicationConfirmDeletePage: React.FC<
  ApplicationConfirmDeleteContext
> = (props) => (
  <Container maxW="lg" py={12}>
    <Box bg="white" borderRadius="lg" shadow="md" p={{ base: 6, md: 8 }}>
...
const AuthorizedTokenDeletePage: React.FC<AuthorizedTokenDeleteContext> = (
  props
) => (
  <Container maxW="lg" py={12}>
    <Box bg="white" borderRadius="lg" shadow="md" p={{ base: 6, md: 8 }}>
